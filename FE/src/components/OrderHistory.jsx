  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="sticky top-0 bg-gradient-to-r from-red-600 to-orange-500 p-6 flex items-center justify-between rounded-t-2xl z-10">
          ...
          <div className="p-6">
            {orders.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-sm text-gray-400 mt-1">Hãy mua sắm ngay!</p>
              </div>
            ) : (
              <div className="space-y-6">
                {orders.map((order) => (
                  <div
                    key={order.id}
                    className="border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-white to-orange-50/40"
                  >
                    {/* Order Header */}
                    ...
                    {/* Order Info */}
                    <div className="bg-gradient-to-r from-slate-50 to-gray-50 border border-gray-100 rounded-xl p-4 space-y-2">
